      ...
      <div className="container mx-auto px-4 py-8 pt-24">
        <div className="max-w-2xl mx-auto">
          ...
          <div className="text-center mb-10">
            ...
            <p className="text-[#5F7D83] text-lg font-medium">
              Your feedback helps us improve our service standards and ensures quality for everyone.
            </p>
          </div>

          {/* Main Card */}
          <div className="bg-white rounded-3xl shadow-xl shadow-[#1F7F85]/5 border border-[#AEE3E6]/50 p-6 md:p-10 space-y-8">
            ...
            <div className="text-center space-y-4">
              ...
              <p className="text-sm font-bold text-[#1F7F85] bg-[#DCEBEC]/50 inline-block px-4 py-1 rounded-full">
            ...
            <div className="space-y-6">
              ...
              <div className="bg-[#DCEBEC]/30 rounded-2xl p-6 border border-[#AEE3E6]">
                <div className="flex flex-col md:flex-row items-center gap-6">
                  {/* Technician Avatar */}
                  <div className="relative">
                    <div className="w-24 h-24 rounded-full overflow-hidden border-4 border-white shadow-lg shadow-[#1F7F85]/10">
                      <img 
                    ...
                    <div className="absolute -bottom-2 -right-2 bg-[#1F7F85] text-white text-xs font-bold px-2 py-1 rounded-full border-2 border-white">
                      ★ 4.9
                    </div>
                  </div>
                  ...
                  <div className="flex-1 text-center md:text-left">
                    ...
                    <div className="inline-flex items-center gap-2 bg-white px-3 py-1.5 rounded-lg border border-[#AEE3E6]">
                      <span className="w-2 h-2 bg-emerald-500 rounded-full animate-pulse"></span>
                      <span className="text-xs font-bold text-[#1F7F85] uppercase tracking-wide">
            ...
            <div className="space-y-4">
              ...
              <div className="relative">
                <textarea
                  className="w-full min-h-[180px] rounded-2xl border-2 border-[#DCEBEC] bg-[#F7FBFC] text-[#1A2E35] p-5 text-base resize-none focus:border-[#1F7F85] focus:ring-4 focus:ring-[#1F7F85]/10 transition-all duration-200 placeholder:text-[#5F7D83]/50"
            ...
            <div className="space-y-4">
              ...
              <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-4">
                {/* Upload Button */}
                <label className="aspect-square flex flex-col items-center justify-center border-2 border-dashed border-[#6FC2C6] rounded-2xl bg-[#F7FBFC] hover:bg-[#DCEBEC] hover:border-[#1F7F85] transition-all cursor-pointer group relative">
                  <input
                    type="file"
                    className="hidden"
                    accept="image/*"
                ...
                {photos.map((photo) => (
                  <div
                    key={photo.id}
                    className="aspect-square rounded-2xl overflow-hidden relative group border border-[#DCEBEC]"
                  >
                    <img
                      src={photo.url}
                      alt={photo.alt}
            ...
            <div className="flex flex-col md:flex-row gap-4 pt-6">
              <button
                ...
                className="flex-1 bg-[#1F7F85] hover:bg-[#0F4C5C] text-white font-bold text-lg py-4 px-8 rounded-xl shadow-lg shadow-[#1F7F85]/20 hover:shadow-[#1F7F85]/40 transition-all duration-300 transform hover:-translate-y-1 active:translate-y-0 flex items-center justify-center gap-3"
              >
                <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <button
                onClick={handleSkip}
                className="md:w-auto px-8 py-4 border-2 border-[#DCEBEC] text-[#5F7D83] font-bold rounded-xl hover:bg-[#F7FBFC] hover:text-[#1F7F85] hover:border-[#1F7F85] transition-all"
              >
                Skip for now
              </button>
            </div>
            ...
            {/* Privacy Notice */}
            <div className="text-center pt-6 border-t border-[#DCEBEC]">
              <div className="flex items-center justify-center gap-2 text-sm text-[#5F7D83]">
                ...
                <span className="w-1 h-1 bg-[#DCEBEC] rounded-full"></span>
