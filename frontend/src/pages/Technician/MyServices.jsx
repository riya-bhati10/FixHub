  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      <div className="flex justify-between items-center mb-8">
        <div>
          <h1 className="text-xl sm:text-2xl md:text-3xl font-bold text-fixhub-textDark mb-2">My Services</h1>
          <p className="text-xs sm:text-sm text-fixhub-textMuted">Manage and view all your created services</p>
        </div>
        ...
        <div className="bg-white rounded-lg shadow-md p-4 sm:p-6 border border-fixhub-borderSoft">
          <div className="flex items-center">
            ...
            <div className="ml-3 sm:ml-4">
              <p className="text-xl sm:text-2xl font-bold text-fixhub-textDark">{services.length}</p>
              <p className="text-xs sm:text-sm text-fixhub-textMuted">Total Services</p>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white rounded-lg shadow-md p-4 sm:p-6 border border-fixhub-borderSoft">
          <div className="flex items-center gap-3 sm:gap-4">
            ...
            <div>
              ...
              <p className="text-xs sm:text-sm text-fixhub-textMuted">Active Services</p>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white rounded-lg shadow-md p-4 sm:p-6 border border-fixhub-borderSoft">
          <div className="flex items-center gap-3 sm:gap-4">
            ...
            <div>
              ...
              <p className="text-xs sm:text-sm text-fixhub-textMuted">Total Value</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6">
        {services.length > 0 ? (
          services.map((service) => (
            <div key={service._id} className="bg-white rounded-xl border-2 border-fixhub-borderSoft hover:border-fixhub-primary shadow-sm hover:shadow-xl transition-all duration-300 hover:-translate-y-1 overflow-hidden">
              <div className="h-24 sm:h-32 bg-gradient-to-br from-fixhub-primary to-fixhub-dark relative">
                ...
                <div className="absolute bottom-2 sm:bottom-3 left-2 sm:left-3 bg-white/95 p-1.5 sm:p-2 rounded-lg shadow-lg">
                  <svg className="w-6 h-6 sm:w-8 sm:h-8 text-fixhub-primary" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 11H5m14 0a2 2 0 012 2v6a2 2 0 01-2 2H5a2 2 0 01-2-2v-6a2 2 0 012-2m14 0V9a2 2 0 00-2-2M5 11V9a2 2 0 012-2m0 0V5a2 2 0 012-2h6a2 2 0 012 2v2M7 7h10" />
                  </svg>
                </div>
              </div>
                ...
                <div className="space-y-1.5 sm:space-y-2 mb-3 sm:mb-4">
                  <div className="flex items-center justify-between text-xs sm:text-sm">
                    <span className="text-fixhub-textMuted flex items-center gap-1">
                      <svg className="w-3 h-3 sm:w-4 sm:h-4 text-fixhub-primary" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08.402 2.599 1M12 8V7m0 1v8m0 0v1m0-1c-1.11 0-2.08-.402-2.599-1" />
                      </svg>
                      Charge
                    </span>
                    <span className="font-bold text-fixhub-textDark">₹{service.serviceCharge}</span>
                  </div>
                  <div className="flex items-center justify-between text-xs sm:text-sm">
                    <span className="text-fixhub-textMuted flex items-center gap-1">
                      <svg className="w-3 h-3 sm:w-4 sm:h-4 text-fixhub-primary" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <span className="font-bold text-fixhub-textDark">{service.experience}</span>
                  </div>
                </div>
