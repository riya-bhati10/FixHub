...
import logo from '../../../public/signal-2026-01-24-124422.png';
        ...
        <div className="flex items-center justify-between h-20">
          ...
          <div className="flex-shrink-0 cursor-pointer" onClick={() => navigate('/dashboard')}>
            <div className="flex items-center gap-3">
              <img src={logo} alt="FixHub Logo" className="h-20 w-20" />
          ...
          <div className="flex items-center gap-4">
            ...
            <div className="hidden md:block relative">
              ...
              {isProfileOpen && (
                <div className="absolute right-0 mt-2 w-56 bg-white rounded-xl shadow-xl border border-slate-100 py-2 z-50 animate-fade-in-up">
